...
export default function Register() {
  ...
  const handleFinish = async (e) => {
    ...
    try {
      await axios.post("https://netflix-serverside.herokuapp.com/api/auth/register", { email,username, password });
      history.push("/login");
    } catch (err) {}
  };
  return (
    <>    <header className="showcase">
        <div className="showcase-top">
            ...
            <button className="btn btn-rounded" onClick={()=>history.push("/login")}>Sign In</button>
        </div>
        <div className="showcase-content">
          ...
          <form className="inputtt">
            ...
            <button className="registerButton" style={{fontSize:"15px"}} onClick={handleFinish}>
